 ...
 * @describtion:
 * @author: frank
 * @date: 2018/7/22 下午11:57
 */
public class DefaultPluginFactory implements PluginFactory,ApplicationContextAware, InitializingBean{
     ...
     */
    @Override
    public void activePlugin(String pluginConfigId) {
        if(configs.containsKey(pluginConfigId)){
            throw new RuntimeException(String.format("已存在指定插件，id=%s",pluginConfigId));
        }
